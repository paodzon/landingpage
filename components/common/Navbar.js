...
const reservationNav = [
  { name: 'Baptismal Rites', href: '/reservations/baptismal' },
  { name: 'First Reconciliation', href: '/reservations/reconciliation' },
  { name: 'First Holy Communion', href: '/reservations/communion' },
  { name: 'Confirmation Rites', href: '/reservations/confirmation' },
  { name: 'Wedding Rites', href: '/reservations/wedding' },
